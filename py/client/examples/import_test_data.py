...
def import_taxi_records(dh_session: Session) -> Table:
    ...
    csv_file_name = download_file(url="https://nyc-tlc.s3.amazonaws.com/trip+data/yellow_tripdata_2020-12.parquet", file_name="sample.parquet")
    pa_table = parquet.read_table(csv_file_name)
