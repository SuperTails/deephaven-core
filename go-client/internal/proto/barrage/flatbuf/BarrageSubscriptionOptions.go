...
func (rcv *BarrageSubscriptionOptions) MaxMessageSize() int32 {
...
/// of one row per batch). If the message size limit cannot be met due to large row sizes, the server will throw a
/// `Status.RESOURCE_EXHAUSTED` exception
func (rcv *BarrageSubscriptionOptions) MutateMaxMessageSize(n int32) bool {
...
func BarrageSubscriptionOptionsAddMaxMessageSize(builder *flatbuffers.Builder, maxMessageSize int32) {
	builder.PrependInt32Slot(4, maxMessageSize, 0)
}
